...
const RisknIssuesUrl = `http://localhost:8080/o/c/risksandissues/?p_auth=${Liferay.authToken}&pageSize=${pageSizeNum}&filter=r_withRiskAndIssues_c_projecttId eq '${ProjectApiId.value}'`;
