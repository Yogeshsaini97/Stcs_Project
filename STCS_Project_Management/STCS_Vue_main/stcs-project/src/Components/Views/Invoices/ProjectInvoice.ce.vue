...
const InvoicesUrl = `http://localhost:8080/o/c/invoices/?p_auth=${Liferay.authToken}&pageSize=${pageSizeNum}&filter=r_withInvoice_c_projecttId eq '${ProjectApiId.value}'`;
